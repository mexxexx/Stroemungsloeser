...
void solvePoisson(double *p, double *rhs, char *FLAG, double omega, double epsilon, int itermax, double deltaX, 
					double deltaY, int imax, int jmax, int numFluidCells, int* iter, double *res);

void computeDelt(double *delt, double delt_min, int imax, int jmax, double delx, double dely, 
...
void computeFG(double *U, double *V, double *F, double *G, double *TEMP, char *FLAG, int imax, 
					int jmax, double delt, double delx, double dely, double GX, double GY, double alpha, double Re, double beta);
